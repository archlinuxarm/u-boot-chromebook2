...
#define CONFIG_IROM_WORKAROUND_BASE	(CONFIG_PHY_IRAM_BASE	\
 ...
 * CPU State Settings
 */
#define CONFIG_CPU_STATE		(CONFIG_IROM_WORKAROUND_BASE + 0x28)
#define CONFIG_GIC_STATE		(CONFIG_IROM_WORKAROUND_BASE + 0x38)
